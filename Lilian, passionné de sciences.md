...
- *Lilian, Passionné de Sciences* : {1}{W}{U}{G}
  > Il agit comme [Captain Sisay](https://scryfall.com/card/inv/237/captain-sisay) il va tuto une légendaire et la met en main.
  > 1/4, Histoire des sciences -- {T} : Cherchez dans votre bibliothèque une carte légendaire, révélez cette carte et mettez-la dans votre main. Mélangez ensuite votre bibliothèque.
  > Avec ma photo Link, et en Mythique.
...
- *Isaac Newton et la gravité* : {3}{W}{U}
  > Loyauté à 4, son +2 génère un jeton Food (pour la pomme), et son -1 empêche une créature non volante d'attaquer une fois, et son ultimate à 7 donne un emblème qui fait définitivement et/ou donne le vol à ses créatures, Mythique.
...
- *Euclide*, {G}{U}, 2/2 (=> artefact *Principes d'Euclide*), Rare.
- *Léonard Euler*, {2}{G}{U}, 4/4 (=> théorème *Théorème d'Euler*), Rare.
...
- *Aristote, le Levier* (mécanique) frame rétro, il fait levier c'est un mur et il peut engager une créature adverse en s'engageant
- *Max Planck* (physique quantique) : Energy quanta : s'engage pour booster marqueurs +1/+1 le board
- *Erwin Schrödinger* (physique quantique) avec du phasing ou du blink (là / pas là)
- *Stephen Hawking* (physique des trous noirs) : genre Assassin Royal, s'engage pour détruire une créature engagée ciblée, ou genre Nemesis truc qui s'engage pour tuer une créature ciblée et l'empêche de regénérer.
- *Sheldon Cooper* (The Big Bang Theory, physique quantique) Bazinga! -- s'engage pour pinger une cible de 1 blessures, That's my spot! -- voler un land ? c'est trop fort, il faut autoriser max un seul land volé à chaque instant.

#### Informaticiens (sans carte associée) : en G + W (Selesnya)

- *Stephen Cook* {5}{U}{G}, 8/6 trample. NP completeness -- At the beginning of your upkeep, you may return target card from your graveyard to your hand (problèmes NP complets)
- *Marvin Minsky et John McCarthy*, {1}{U}{G}, 5/3, Artificial intelligence -- {T},{X}: Up to one target non-creature artifact with mana value X or less becomes an artifact creature with power and toughness each equal to its mana value. (intelligence artificielle)
- *Yoshua Bengio et Yann LeCun*, {1}{U}{G} 4/3, trample, Neural networks -- creatures and non-basic lands your opponents control enter the battlefield tapped. (réseaux de Neurones)
- *Tim Berners-Lee, grand navigateur*, {2}{U}{G}, 4/5, Reach, Web browser -- {T},{X}: destroy target creature with flying with mana value X or less. (WWW, navigateur web)
- *Rivest, Shamir et Adleman*, {U}{G}, 2/2, Cryptography -- Activated abilities of artifacts can't be activated. (cryptographie à clef publique et RSA)

#### Mathématiciens (sans carte associée) : en U + G (Simic)

- *Pythagore* (géométrie) {G}{W} frame rétro
- *Pascal, probabiliste avant l'heure* {1}{G}{W} (probabilité)
- *Évariste Galois, mort trop jeune* {1}{G}{W} (théorie des corps)
- *Cauchy, intègre professeur* {2}{G}{W} (intégrales)
- *Ramanujan, génie autodictate* {2}{G}{W} (séries infinies)
...
- *Agrégatif // Professeur agrégé* : {1}{G}{W}{U} : double-faced card, 2/4 up, humain et étudiant, 6/6 down, humain et chercheur, se retourne en payant 5 life pendant sa phase de fin. Down : parade 1, piétinement et lien de vie, Rare.
- *Doctorante // Docteure ès sciences* : {2}{G}{W}{U} : double-faced card, 3/6 up, humain et étudiant, 7/7 down, humain et chercheur, piétinement et lien de vie, Rare.
...
- *Doyen de l'Université* : {1}{G}{G} lord +1/+1 à tous les autres G, 2/2, humain et chercheur, Rare.
...
- *Classe : physicien* : {W}{U}, The first artifact spell you cast each turn costs {1} less to cast. {1}{U}: Level 2 : When this Class becomes level 2, reveal cards from the top of your library until you reveal an artifact card. Put that card into your hand and the rest on the bottom of your library in a random order. {5}{U}: Level 3 : At the beginning of your end step, create a token that's a copy of target artifact you control, except it is not legendary.
...
- *Classe : informaticien* : {W}{G}, Spells your opponents cast during your turn cost {1} more to cast. {1}{W}: Level 2 : Creatures you control get +1/+1. {3}{W}: Level 3 : Whenever you attack, until end of turn, target attacking creature gets +1/+1 for each other attacking creature and gains double strike.
...
- *Remises de prix* : {1}{W}{U}{G}, phase 1 : sur les étudiants, phase 2 : au choix Prix Nobel sur les physiciens, Prix Turing sur les informaticiens, Médaille Field sur les mathématiciens, phase 3 : gros buff à tout le board
- *Demande de financement* : {2}{G}, ça demande d'engager une créature qu'on contrôle comme coût supplémentaire à chaque phase. Phase 1 et 2 : créer un jeton trésor, phase 2 : créer un jeton trésor, phase 3 : tuto un rituel (représente le papier accepté)

### 3 Enchantements : théorèmes
> Cf. plus haut, un par légendaires qui tuto son théorème ?

- *Théorie de la Relativité* : {1}{W}{W} : Creatures you control have first strike. Creatures your opponents control lose first strike and can't have or gain first strike.
- *Algorithme de Dijkstra* : {2}{G}{G} : At the beginning of combat during your turn, you may choose a target creature. That creature cannot be blocked this turn.
- *Théorème d'Euler* : {2}{U} : You may have CARDNAME enter the battlefield as a copy of any artifact or enchantment on the battlefield.
